...
#define STRING_CONFIG_H_AUTHOR "(Alexander von Gluck IV, SD2 + E3D + Custom Heater)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {88,88,2268,104} // default steps per unit for Solidoodle 2
